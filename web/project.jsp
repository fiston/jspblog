...
<sql:query var="pO" dataSource="jdbc/s3f4Pool">
    SELECT projectid,projecttitle,projectcontent FROM project Where projectid=<%= request.getParameter("id") %>
</sql:query>
...
<br />
    ...
    <div id="sagAnaIcerik">
        <c:forEach var="p" items="${pO.rows}">
            <a href="project.jsp?id=${p.projectid}" id="title"> ${p.projecttitle}</a>
            <div id="content">
                ${p.projectcontent}
            </div>
        </c:forEach>
